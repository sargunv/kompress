...
public fun ByteString.decompressed(decompressor: Decompressor = Inflater()): ByteString =
  buildByteString {
    decompressor.push(this@decompressed.toByteArray(), finish = true, onOutput = ::append)
  }

public fun ByteString.compressed(compressor: Compressor = Deflater()): ByteString =
  buildByteString {
    compressor.push(this@compressed.toByteArray(), finish = true, onOutput = ::append)
  }

public fun ByteArray.compressed(compressor: Compressor = Deflater()): ByteArray =
  buildByteString { compressor.push(this@compressed, finish = true, onOutput = ::append) }
    .toByteArray()

public fun ByteArray.decompressed(decompressor: Decompressor = Inflater()): ByteArray =
  buildByteString { decompressor.push(this@decompressed, finish = true, onOutput = ::append) }
    .toByteArray()
